export default class Select{
 ...
 const chosenNumber = document.querySelector('.chosen-button')
 ...
 function setupCustomElement(select){
     ...
     select.options.forEach(option => {
         ...
         optionElement.addEventListener('click', () => {
             ...
             chosenNumber.innerHTML = `You chose the number ${option.value}`
         })
          ...
          switch(e.code){
               ...
               case "ArrowUp":
                    ...
                    if(prevOption){
                         ...
                         chosenNumber.innerHTML = `You chose the number ${prevOption.value}`
                    }
                    break
               case "ArrowDown":
                    ...
                    if(nextOption){
                         ...
                         chosenNumber.innerHTML = `You chose the number ${nextOption.value}`
                    }
                    break
               case "Enter":
               case "Escape":
